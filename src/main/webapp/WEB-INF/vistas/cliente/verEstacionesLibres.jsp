      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th scope="col"></th>
            <h3>
              <i class="bi bi-info-circle"> ${mensajeError }</i>
            </h3>
          </tr>
        </thead>
        <tbody>
              ...
              <td>
                <table class="table">
                  ...
                  <c:forEach var="ele2" items="${ele.conectores }">
                    <tr>
                      <td>${ele2.nombre }</td>
                      <td><a class="btn btn-warning " href="/cliente/reservar/${ele.idEstacion }/${ele2.idConector }/${fecha}/1/${ele2.nombre}"><i
                          class="bi bi-brightness-high"> Mañana</i></a> <a class="btn btn-info "
                        href="/cliente/reservar/${ele.idEstacion }/${ele2.idConector }/${fecha}/2/${ele2.nombre}"><i class="bi bi-sunset">
                            Tarde</i></a></td>
                    </tr>
                  </c:forEach>
                </table>
