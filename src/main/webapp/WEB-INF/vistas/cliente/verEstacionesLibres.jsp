...
<table class="table">
  ...
  <tr>
     ...
     <c:forEach var="ele2" items="${ele.conectores }">
    	...
    	<a class="btn btn-success " href="/cliente/reservar/${ele.idEstacion }/${ele2.idConector }/${fecha}/1"><i
							class="bi bi-journal-plus"> Mañana</i></a>
							 <a class="btn btn-success " href="/cliente/reservar/${ele.idEstacion }/${ele2.idConector }/${fecha}/2"><i
							class="bi bi-journal-plus"> Tarde</i></a>
							<br>
