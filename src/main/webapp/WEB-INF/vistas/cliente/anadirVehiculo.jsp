...
<form action="/cliente/anadirVehiculo" method="post">
    ...
    <input type="text" class="form-control" required placeholder="Marca" name="nombre">
  	</div>
  	<div class="form-group">
    ...
    <input type="number" class="form-control"  placeholder="Potencia" name="potencia">
  	</div>
  	<div class="form-group">
    <label for="matricula">Autonomia</label>
    <input type="number" class="form-control"  placeholder="Autonomia" name="autonomia">
  	</div>
  	<div class="form-group">
    ...
    <select  class="form-select" aria-label="Default select example" name="idBateria" required>
