          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <sec:authorize access="isAuthenticated()">
                <li class="nav-item"><a class="nav-link" href="/cliente/"><i class="bi bi-box-arrow-right"> Volver</i></a></li>
              </sec:authorize>
              <sec:authorize access="isAuthenticated()">
            ...
            <form class="form-horizontal" method="post" action="/cliente/addCarrito">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <label>Estacion</label> <input id="idEstacion" type="text" name="idEstacion" value="${reserva.estacione.idEstacion }" readonly
                      class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                  <div class="col-md-8">
                    <label>Direccion</label> <input id="direccion" type="text" name="direccion" value="${reserva.estacione.direccion }" readonly
                      class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                  <div class="col-md-8">
                    <label>Dia Carga</label> <input id="fechaServicio" name="fecha" type="text"
                      value="<fmt:formatDate pattern = "dd-MM-yyyy" value = "${reserva.fechaServicio}" />" readonly class="form-control">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <label>Conector</label> <input id="descripcion" name="descripcion" value="${reserva.descripcion}" readonly class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-phone-square bigicon"></i></span>
                  <div class="col-md-8">
                    <label>Minutos Carga</label> <input id="minutos" type="number" required class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-phone-square bigicon"></i></span>
                  <div class="col-md-8">
                    <label>Precio</label> <input id="precio" name="precioTotal" readonly class="form-control">
                  </div>
                </div>
                <br>
                <div class="form-group">
