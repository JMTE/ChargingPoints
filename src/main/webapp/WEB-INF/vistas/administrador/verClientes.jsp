          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <sec:authorize access="hasAuthority('ADMIN')">
                <li>
                  <form class="d-flex" action="/administrador/buscarCliente" method="post">
        ...
        <tbody>
          <c:forEach var="ele" items="${listaClientes}">
            <tr>
              ...
              <td><a class="btn btn-success " href="/administrador/historialUsuario/${ele.username }">Historial <i class="bi bi-activity"></i></a>
              </td>
              <td><a class="btn btn-danger " href="/administrador/eliminarUsuario/${ele.username }">Eliminar <i class="bi bi-trash"></i></a></td>
            </tr>
          </c:forEach>
        </tbody>
      </table>
