        ...
        <tbody>
          <c:forEach var="ele" items="${listaUsuarios}">
            <tr>
              ...
              <td><a class="btn btn-success " href="/administrador/historialUsuario/${ele.username }">Historial <i class="bi bi-activity"></i>
              </a></td>
              <td><a class="btn btn-danger " href="/administrador/eliminarUsuario/${ele.username }">Eliminar <i class="bi bi-trash"></i>
              </a></td>
            </tr>
          </c:forEach>
        </tbody>
      </table>
      <a class="btn btn-success " href="/administrador/altaAdmin">Añadir Administrador <i class="bi bi-plus-circle"></i>
      </a>
    </div>
  </div>
</body>
