...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand  " href="/index"><i class="bi bi-shop"> CHARGING POINTS</i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
       <sec:authorize access="hasAuthority('ADMIN')">
        <li class="nav-item">
          <a class="nav-link  " aria-current="page" href="/administrador/verUsuarios"><i class="bi bi-people-fill"> Usuarios</i></a>
        </li>
        </sec:authorize>
       
        <sec:authorize access="hasAuthority('ADMIN')">
        <li class="nav-item">
          <a class="nav-link" href="/administrador/verClientes"><i class="bi bi-bag"> Clientes</i></a>
        </li>
        </sec:authorize>
        
         <sec:authorize access="hasAuthority('EMPRE')">
        <li class="nav-item">
          <a class="nav-link" href="/empresa/verClientes"><i class="bi bi-bag"> Clientes</i></a>
        </li>
        </sec:authorize>
           <sec:authorize access="hasAuthority('EMPRE')">
        <li class="nav-item">
          <a class="nav-link" href="/empresa/verRecargas"><i class="bi bi-bag"> Recargas</i></a>
        </li>
        </sec:authorize>
         ...
         <sec:authorize access="hasAuthority('ADMIN')">
         <li class="nav-item">
          <a class="nav-link" href="/administrador/verEmpresas"><i class="bi bi-book"> Empresas</i></a>
        </li>
         ...
         <sec:authorize access="hasAuthority('ADMIN')">
        <li class="nav-item">
          <a class="nav-link" href="/administrador/verReservas"><i class="bi bi-bag"> Reservas</i></a>
        </li>
        </sec:authorize>
        ...
        <li class="nav-item" >
         ...
         <sec:authorize access="hasAuthority('CLIEN')">
        <li class="nav-item" >
          <a class="nav-link" href="/cliente/añadirVehiculo"><i class="bi bi-cart"> Añadir Vehiculo </i></a>
        </li>
        </sec:authorize>
        <sec:authorize access="hasAuthority('CLIEN')">
        <li class="nav-item" >
 		 <form class="d-flex" action="/tema" method="post">
      	<input class="form-control me-2"  type="text" name="fecha" placeholder="Fecha para Reserva" onclick="ocultarError();" onfocus="(this.type='date')" onblur="(this.type='text')" aria-label="Search" name="fecha">
